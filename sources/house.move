// this module represents the house
module blackjack::house {
    ...
    // @note not really a fan of this, why don't we just do this in the init function?
    ...
    // withdraw the entire balance of the house object
